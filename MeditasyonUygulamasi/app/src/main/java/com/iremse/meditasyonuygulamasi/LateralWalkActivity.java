...
public class LateralWalkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lateral_walk);
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(LateralWalkActivity.this, "Tebrikler!", Toast.LENGTH_SHORT).show();
                // MainActivity'e geçiş yap
                Intent intent = new Intent(LateralWalkActivity.this, YogaActivity.class);
