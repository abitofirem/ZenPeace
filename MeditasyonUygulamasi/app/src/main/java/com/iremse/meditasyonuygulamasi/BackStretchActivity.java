...
public class BackStretchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_stretch);
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(BackStretchActivity.this, "Tebrikler!", Toast.LENGTH_SHORT).show();
                // MainActivity'e geçiş yap
                Intent intent = new Intent(BackStretchActivity.this, YogaActivity.class);
