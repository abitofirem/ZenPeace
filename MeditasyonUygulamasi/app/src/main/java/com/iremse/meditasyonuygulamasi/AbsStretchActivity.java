...
public class AbsStretchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abs_stretch);
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(AbsStretchActivity.this, "Tebrikler!", Toast.LENGTH_SHORT).show();
                // MainActivity'e geçiş yap
                Intent intent = new Intent(AbsStretchActivity.this, YogaActivity.class);
